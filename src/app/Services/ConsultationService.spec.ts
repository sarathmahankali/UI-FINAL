...
describe("ConsultationService",()=>{
    ...
    let mockAppointmentDetails: AppointmentCard;
  
    
    beforeEach(async () => {
        service = new ConsultationService(http);
    ...
    it('Should get All Appointment details by vet Id and Date filter',() =>{
        ...
        const req = httpTestingController.expectOne({
            method:'GET',
            url:`${environment.ConsultationMockURL}api/appointments/getappointments/${id}/${role}/${Fromdate}/${Todate}`
        });
